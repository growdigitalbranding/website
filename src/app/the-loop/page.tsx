      ...
      <article className="mx-auto max-w-3xl px-6 py-16 flex flex-col gap-16">
        ...
        <section>
          ...
          <p className="text-lg text-graphite mb-4">
            ...
            was a student doing a college project. Unless you tell them. Server-side tracking (CAPI, sGTM, offline conversion uploads) is how you tell them, every week, in a
            format the algorithm can learn from.
          </p>
          <p className="text-lg text-graphite">
            <strong className="text-ink">What it costs to skip:</strong> without a signal loop,
            the algorithm keeps optimising toward whatever converted to "lead" in its dashboard, usually the cheapest and least-qualified action available. You end up buying more of
