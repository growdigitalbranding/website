  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="press absolute right-0 top-1/2 -translate-y-1/2 flex items-center justify-center w-8 h-8 rounded-full border border-mist bg-paper text-graphite hover:text-ink"
      >
