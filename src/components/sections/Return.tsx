export function Return() {
  return (
    <section className="bg-ink text-paper py-24 md:py-32 relative">
      <div className="mx-auto max-w-[1440px] px-6">
        <p className="mono-label text-pulse mb-6">↩ THE RETURN</p>
        <h2 className="text-h2 font-display font-bold max-w-2xl">
